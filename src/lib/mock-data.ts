...
// User 1: Sarah J. Assenmon (sarah.j@userfacet.com) - Product & Executive Lead
const SARAH_EMAILS: Email[] = [
  {
    ...
    messages: [
      msg(
        ...
        "sarah.j@userfacet.com",
      ),
      msg(
        "s-e1m2",
        "Mark Chen",
        "mark.c@userfacet.com",
        "11:41 AM",
  ...
  },
  {
    ...
    senderEmail: "dana.w@userfacet.com",
    preview:
  ...
  },
  {
    ...
    sender: "Finance Desk",
    senderEmail: "finance@userfacet.com",
    preview:
  ...
  },
  {
    ...
    senderEmail: "sarah.j@userfacet.com",
    preview:
...
// User 2: Mark Chen (mark.c@userfacet.com) - Senior Tech Lead & Architect
const MARK_EMAILS: Email[] = [
  {
    ...
    senderEmail: "alerts@monitoring.userfacet.com",
    preview:
  ...
  },
  {
    ...
    sender: "Alex Taylor",
    senderEmail: "alex.t@userfacet.com",
    preview:
  ...
  },
  {
    ...
    sender: "SecOps Bot",
    senderEmail: "secops@userfacet.com",
    preview:
  ...
  },
  {
    ...
    senderEmail: "ai-infra@userfacet.com",
    preview:
  ...
  },
  {
    ...
    sender: "Mark Chen",
    senderEmail: "mark.c@userfacet.com",
...
// User 3: Ops Service Account (ops.svc@userfacet.com) - IT Infrastructure & Operations
const OPS_EMAILS: Email[] = [
  {
    ...
    senderEmail: "certs@userfacet.com",
    preview:
      "Certificate *.userfacet.com expires on Aug 28, 2026. ACME HTTP-01 challenge verification required.",
    time: "08:00 AM",
    unread: true,
    starred: true,
    priority: true,
  ...
  },
  {
    ...
    senderEmail: "db-backup@userfacet.com",
  ...
  },
  {
    ...
    senderEmail: "access-control@userfacet.com",
    preview:
      "User dev.alex@userfacet.com requested 30-day temporary read-only access to Production Replica DB.",
    time: "Yesterday",
    unread: true,
    starred: false,
    priority: true,
  ...
  },
  {
    ...
    senderEmail: "infra-bot@userfacet.com",
    preview:
  ...
  },
  {
    ...
    senderEmail: "ops.svc@userfacet.com",
    preview:
      "Granted 30-day read-only replica DB access to dev.alex@userfacet.com with audit logging enabled.",
    time: "Yesterday",
    unread: false,
    starred: false,
    priority: false,
    ...
    messages: [
      msg(
        ...
        "ops.svc@userfacet.com",
        "Yesterday",
        "Approved ticket #8942 for dev.alex@userfacet.com. Access token activated with 30-day auto-revocation policy.",
        undefined,
        "access-control@userfacet.com",
      ),
    ],
...
const OPS_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    detail: "*.userfacet.com wildcard cert expires in 14 days.",
    time: "5m ago",
    kind: "reminder",
    read: false,
  },
